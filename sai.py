...
#tinkerbell
cl = LINETCR.LINE()
cl.login(token='EoGqrZgF9GpOi4K7gE03.X805iGriInO2zaIndNDUSW.SYZuqra/p1tc5nWn7/3hDenNpXGAV4ShohDx3627TEE=')
cl.loginResult()
#vidia
kt = LINETCR.LINE()
kt.login(token='EoGqrZgF9GpOi4K7gE03.X805iGriInO2zaIndNDUSW.SYZuqra/p1tc5nWn7/3hDenNpXGAV4ShohDx3627TEE=')
kt.loginResult()
...
autoleaveroom = []
targets = []
Bots=[mid,Emid,"uc7cd3922044888da3664088d0e776eb3"]
admin = ["uc7cd3922044888da3664088d0e776eb3"]
owner = ["uc7cd3922044888da3664088d0e776eb3"]
wait = {
    'contact':False,
    'autoJoin':False,
    'autoCancel':{"on":False, "members":25},
    'leaveRoom':False,
    'timeline':True,
    'autoAdd':False,
...
#================================================================================
            elif 'Cancenall' in msg.text.lower():
	      if msg.from_ in admin:
                if msg.toType == 2:
...
#===========================================================================
            ...
            elif 'Link off' in msg.text.lower():
              if msg.from_ in admin:
                if msg.toType == 2:
                    uye = random.choice(KAC)
                    X = cl.getGroup(msg.to)
...
#=================================================================
            elif msg.text in ["Protect:Sear","protect:Sear"]:
              if msg.from_ in admin:
                if wait["protectionOn"] == True:
                    if wait["lang"] == "JP":
...
#============================================================
            elif "Sear mid @" in msg.text:
              if msg.from_ in admin:
                key = eval(msg.contentMetadata["MENTION"])
                key1 = key["MENTIONEES"][0]["M"]
                cl.sendText(msg.to,"Mc: " + key1)
            elif "Sear contact @" in msg.text:
              if msg.from_ in admin:
                key = eval(msg.contentMetadata["MENTION"])
                key1 = key["MENTIONEES"][0]["M"]                
...
#=====================================================================================
#---------------------ฝากออโต้-----------------------------------
            elif "ฝาก:" in msg.text:
                bctxt = msg.text.replace("ฝาก:", "")
                a = cl.getGroupIdsJoined()
                for manusia in a:
                    cl.sendText(manusia, (bctxt))
            elif msg.text in ["Sear bye"]:
              if msg.from_ in admin:
				gid = cl.getGroupIdsJoined()
				for i in gid:
					cl.leaveGroup(i)

...
cl = LINETCR.LINE()
cl.login(token="EoSXRBw6EhPdnbXxJ8Zb.w6+8YbOkbOMyiHAGbC+hcW.BavQR8Wk85TwKtW01P/xchKMrEQ/5QJgl9PiMX62ahM")
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                try:
                    ...
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto like by ^S̶t̶a̶r̶t̶ b̶o̶t̶^\nStatus Boss udah Kami Like\nOwner Kami :\nKoplaxs")
                    ki.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId']," ✰S̶t̶a̶r̶t̶ b̶o̶t̶✰")
                    print "Like"
                except:
                    pass
            else:
